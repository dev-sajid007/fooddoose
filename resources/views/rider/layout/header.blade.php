<nav class="navbar navbar-expand-xl navbar-light bg-light fixed-top">
    <div class="container-fluid">
        ...
        <!-- navbar logo -->
        <a class="navbar-brand me-auto ms-lg-0 ms-3 text-uppercase fw-bold" href="{{route('rider.dashboard')}}">
                        <img width="150px" src="{{asset('assets/rider_assets/images/logo.png')}}" alt="">
        </a>
                                            ...
                                            <ul class="contacts">
                                                ...
                                                <li class="active dlab-chat-user">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img
                                                                src="{{asset('assets/rider_assets/images/avatar/1.jpg')}}"
                                                ...
                                                <li class="dlab-chat-user">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img
                                                                src="{{asset('assets/rider_assets/images/avatar/2.jpg')}}"
                                                                class="rounded-circle user_img" alt="">
                                                ...
                                                <li class="dlab-chat-user">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img
                                                                src="{{asset('assets/rider_assets/images/avatar/5.jpg')}}"
                                                                class="rounded-circle user_img" alt="">
                                                            <span class="online_icon offline"></span>
                                                        </div>
                                                        <div class="user_info">
                            ...
                            <div class="timeline-panel d-flex justify-content-around">
                                <div class="media me-2">
                                    <img alt="image" class="bradius" width="50"
                                         src="{{asset('assets/rider_assets/images/avatar/3.jpg')}}">
                                </div>
                    ...
                    <a class="nav-link navbar-dropdown-toggle dropdown-toggle ms-2" href="#" role="button"
                       data-bs-toggle="dropdown" aria-expanded="false">
                        <img width="40px" class="rounded-circle"
                             src="{{(!empty(Auth::user()->photo))?url('frontend_upload_asset/upload_assets/riderphoto/'.Auth::user()->photo):url('assets/rider_assets/images/user.jpg')}}" alt="">
                    </a>
                    <ul class="dropdown-menu border-0 shadow-lg p-3 dropdown-menu-end position-absolute">
                        <li>
                            <a href="{{ route('rider.show.profile') }}" class="dropdown-item ai-icon">
                        ...
                        <!--</li>-->
                        <li>
                            <a href="{{route('rider.logout')}}" class="dropdown-item ai-icon">
