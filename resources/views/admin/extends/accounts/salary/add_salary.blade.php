...
<div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form method="post"  enctype="multipart/form-data" id="store_expense">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input name="expense_date"  type="date"  class="form-control" placeholder="expense Date">
							</div>
						</div>
				...
				<div class="modal-footer">
					...
					<button type="submit" style="background:#f46f22;color:white" id="store_expense_submit_button" class="btn ">Add Expense</button>
