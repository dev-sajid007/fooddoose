...
<div class="row mb-1 ml-1">
    <div class="col-md-9 col-sm-12">
        <h5 class="fw-bold text-dark  font-weight-bold">Create Order Page Section</h5>
    </div>
...
@include('admin.extends.orders.rider_assign_modal')
@endsection
@section('js')
<script>
...
serverSide: true,
responsive: true,
ajax: '{!! route('created_orders.list') !!}',
columns: [
{ data: 'id', name: 'id' },
...
// delete end
// start order edit button update model
