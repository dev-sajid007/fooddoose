...
<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post"  enctype="multipart/form-data" action="{{ route('merchant.store') }}" id="regiForm">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="store_expense_submit_button" class="btn btn-primary btn-block">Create Merchant</button>
