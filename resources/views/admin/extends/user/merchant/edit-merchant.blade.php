                ...
                <form method="post"  enctype="multipart/form-data" action="{{ route('merchant.update',$user->id) }}">
                    ...
                    <div class="row pb-5" >
                        ...
                        <h5 style="margin-top:25px;color:green">Schedule Information</h5>
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                               <input {{isset($user->schedule['sunday'])&&$user->schedule['sunday']=='1' ? 'checked' : ''}} class="form-check-input" type="checkbox" name="sunday" value="1"  >
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                               <input {{isset($user->schedule['monday'])&&$user->schedule['monday']=='1' ? 'checked' : ''}} class="form-check-input" type="checkbox" name="monday" value="1" id="1">
                     ...
                     <div class="col-md-2">
                            <div class="form-group">
                               <input {{isset($user->schedule['tuesday'])&&$user->schedule['tuesday']=='1' ? 'checked' : ''}} class="form-check-input" type="checkbox" name="tuesday" value="1" id="1" >
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                               <input {{isset($user->schedule['wednesday'])&&$user->schedule['wednesday']=='1' ? 'checked' : ''}} class="form-check-input" type="checkbox" name="wednesday" value="1" id="1" >
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                               <input {{isset($user->schedule['thursday'])&&$user->schedule['thursday']=='1' ? 'checked' : ''}} class="form-check-input" type="checkbox" name="thursday" value="1" id="1" >
                     ...
                     <div class="col-md-2">
                            <div class="form-group">
                               <input {{isset($user->schedule['friday'])&&$user->schedule['friday']=='1' ? 'checked' : ''}} class="form-check-input" type="checkbox" value="1" id="1" name="friday" >
                          ...
                          <div class="col-md-2" style="margin-top:43px">
                            <div class="form-group">
                               <input {{isset($user->schedule['saturday'])&&$user->schedule['saturday']=='1' ? 'checked' : ''}} class="form-check-input" type="checkbox" value="1" id="1" name="saturday" >
