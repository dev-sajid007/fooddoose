...
<div class="content-area">
  ...
  <div class="row">
    <div class="col-lg-12 text-right">
      ...
      <a href="{{ route('admin-role-index') }}"><button class="btn btn-dark text-right">{{ __('Back To Role') }}</button></a>
    </div>
  </div>
          ...
          <div class="body-area">
            ...
            <form id="geniusform" action="{{route('admin-role-create')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-lg-7">
                  <button class="btn btn-dark" type="submit">{{ __('Create Role') }}</button>
                </div>
              </div>
            </form>
          </div>
