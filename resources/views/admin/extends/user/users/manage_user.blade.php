...
<div class="row mb-1 ml-1">
    <div class="col-md-9 col-sm-12">
        <h5 class="fw-bold text-dark  font-weight-bold"> User Page Section</h5>
    </div>
    ...
    <div class="col-md-12 mb-3">
        ...
        <div class="card">
            <!-- <div class="card-header">
                <h5 class="fw-bold"> user Page Section</h5>
            </div> -->
            <div class="card-body">
...
$.ajax({
url: "delete_user_api/" + dataId, //ajax execution to this url
type: 'delete',
data:{
_token:'{{ csrf_token() }}'
},
...
Swal.fire(
'Deleted!',
'Your user page file has been deleted.',
'success'
)
}
})
