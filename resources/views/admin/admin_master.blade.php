...
@include('sweetalert::alert', ['cdn' => "https://cdn.jsdelivr.net/npm/sweetalert2@9"])
    ...
    <nav class="navbar navbar-expand-xl navbar-light bg-white fixed-top">
      <div class="container-fluid">
        ...
        <!-- navbar logo -->
        <a class="navbar-brand me-auto ms-lg-0 ms-3 text-uppercase fw-bold" href="{{url('admin/dashboard')}}">
          <img width="150px" src="{{asset('frontend_upload_asset/upload_assets/images/logo/'.$admin_dashboard_setting->logo)}}" alt="">
        </a>
        ...
        {{--   <form class="d-flex ms-auto my-3 my-lg-0">
            <div class="input-group">
              <input class="form-control navbar-search-field" type="search" placeholder="Search" aria-label="Search" />
                  ...
                  <div class="tab-content">
                          ...
                          <ul class="contacts">
                            ...
                            <li class="active dlab-chat-user">
                              <div class="d-flex bd-highlight">
                                <div class="img_cont">
                                  <img src="{{asset('/assets/admin_assets/images/avatar/1.jpg')}}" class="rounded-circle user_img" alt="">
                            ...
                            <li class="dlab-chat-user">
                              <div class="d-flex bd-highlight">
                                <div class="img_cont">
                                  <img src="{{asset('/assets/admin_assets/images/avatar/2.jpg')}}" class="rounded-circle user_img" alt="">
                            ...
                            <li class="dlab-chat-user">
                              <div class="d-flex bd-highlight">
                                <div class="img_cont">
                                  <img src="{{asset('/assets/admin_assets/images/avatar/5.jpg')}}" class="rounded-circle user_img" alt="">
                                  <span class="online_icon offline"></span>
                                </div>
                                <div class="user_info">
                    ...
                    <div class="tab-pane fade" id="alerts" role="tabpanel">
                      <div class="card mb-sm-3 mb-md-0 contacts_card border-0">
                        <div class="text-center d-flex justify-content-between align-items-center p-3">
                          <a href="javascript:void(0);"><i class="bi bi-plus fs-4"></i></i>
                          </a>
                          <div>
                            ...
                            <li class="active">
                              <div class="d-flex bd-highlight">
                                ...
                                <div class="ms-auto">
                                  ...
                                  <i class="bi bi-pencil-fill"></i></i></a>
          ...
          {{--   <a class="nav-link ms-2" href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
            ...
            <li class="nav-itme dropdown position-relative">
             {{--  <a class="nav-link navbar-dropdown-toggle dropdown-toggle ms-2" href="#" role="button"
               ...
               {{--  <ul class="dropdown-menu border-0 shadow-lg p-3 dropdown-menu-end position-absolute" style="width: 320px;">
                  <li class="my-2">
                    <div class="timeline-panel d-flex justify-content-around">
                      <div class="media me-2">
                        <img alt="image" class="bradius" width="50" src="{{asset('/assets/admin_assets/images/avatar/3.jpg')}}">
                      </div>
                  ...
                  <li class="my-2">
                    <div class="timeline-panel d-flex justify-content-around">
                      <div class="media me-2">
                        <img alt="image" class="bradius" width="50" src="{{asset('/assets/admin_assets/images/avatar/1.jpg')}}">
                      </div>
                      <div class="media-body">
                        <h6 class="mb-1">Dr sultads Send you Photo</h6>
                        <small class="d-block">29 July 2020 - 02:26 PM</small>
                  ...
                  <li class="my-2">
                    <div class="timeline-panel d-flex justify-content-around">
                      <div class="media me-2">
                        <img alt="image" class="bradius" width="50" src="{{asset('/assets/admin_assets/images/avatar/2.jpg')}}">
                      </div>
                      <div class="media-body">
                        <h6 class="mb-1">Dr sultads Send you Photo</h6>
                        <small class="d-block">29 July 2020 - 02:26 PM</small>
              ...
              <li class="nav-item dropdown position-relative">
                <a class="nav-link navbar-dropdown-toggle dropdown-toggle ms-2" href="#" role="button"
                  data-bs-toggle="dropdown" aria-expanded="false">
                  <img width="40px" class="rounded-circle" src="{{!(empty(Auth::user()->photo))?url('frontend_upload_asset/upload_assets/adminphoto/'.Auth::user()->photo):url('assets/admin_assets/images/user.jpg')}}" alt="">
                </a>
                <ul class="dropdown-menu border-0 shadow-lg p-3 dropdown-menu-end position-absolute">
                  <li> 
                    <a href="{{ route('admin.show.profile') }}" class="dropdown-item ai-icon">
