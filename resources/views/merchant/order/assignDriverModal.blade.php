<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="form_id" method="post" action="{{route('merchant.assign-rider')}}">
                @csrf
                <input id="order_id" name="order_id" readonly hidden >
                <div class="modal-body">
                    <div class="form-group mt-3">
                        <label for="exampleInputEmail1">Delivery Status</label>
                        <select class="form-control" id="deliver_status" name="delivery_status" required>
                            <option selected disabled value="">Select One</option>
                            <option value="self">Self Rider</option>
                            <option value="system">System Rider</option>
                        </select>
                    </div>
