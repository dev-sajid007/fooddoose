...
class PendingRider extends Controller
{
public function show_pending_reader(){
return view('admin.extends.riders.pending.manage_rider');
}



public function get_pending_riders(){
$query = DB::table('users')->where('user_type','rider')->where('status',2)
